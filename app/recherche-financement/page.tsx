      ...
      <div className="mb-6 px-4 md:px-12 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">{theme.modules.length} financements disponibles</p>
          </div>
        </div>
                  ...
                  <div className="relative aspect-video">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4">
                      ...
                      <div className="flex items-center gap-2 text-white/80 text-xs">
                        ...
                        <span>Expertise financement</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="pt-28 pb-20 bg-gradient-to-br from-gray-50 via-red-50/30 to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 tracking-tight">
           Pôle  Recherche de Financement
            <span className="block text-red-600 mt-2">2026</span>
          </h1>
          
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Stratégies et mobilisation de fonds pour propulser vos projets de développement
          </p>
          ...
          <div className="flex justify-center gap-3 mt-10">
            <div className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg shadow-sm">
              ...
              <span className="text-sm font-medium text-gray-700">Expertises Financement</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg shadow-sm">
              <Check className="w-5 h-5 text-red-600" />
              <span className="text-sm font-medium text-gray-700">Stratégies Sur Mesure</span>
            </div>
          </div>
        </div>
      </div>
