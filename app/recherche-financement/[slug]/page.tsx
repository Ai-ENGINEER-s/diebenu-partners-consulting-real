// app/recherche-financement/[slug]/page.tsx
'use client';
...
interface FinancementDetailPageProps { // <-- CHANGÉ
  theme: ThemeForOtherPages;
  module: ModuleForOtherPages;
  setCurrentPage: (page: string) => void;
}

export default function FinancementDetailPage({ theme, module, setCurrentPage }: FinancementDetailPageProps) { // <-- CHANGÉ
    ...
    <>
      ...
      <div className="relative pt-32 pb-64 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <button 
            onClick={() => setCurrentPage('recherche')} // <-- CHANGÉ
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 mb-12 border border-gray-100">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-2">À propos de cette prestation</h2>
          ...
          <div className="bg-gradient-to-br from-red-600 to-red-700 rounded-2xl p-8 md:p-12 shadow-2xl">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-white">
                <h3 className="text-2xl md:text-3xl font-bold mb-2">Intéressé par cette prestation ?</h3>
